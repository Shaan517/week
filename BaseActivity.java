package com.academiccalendar.weekview;
...
import com.academiccalendar.MonthView;
import com.academiccalendar.R;
...
//        itemBuilder.setBackgroundDrawable(getResources().getDrawable(R.mipmap.calendar_month));
        ...
        button_trimester.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        startActivity(new Intent(BaseActivity.this, TriSemAct.class));
                    };
                });
        button_week.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BaseActivity.this, BasicActivity.class));
        ...
        button_month.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(BaseActivity.this, MonthView.class));
